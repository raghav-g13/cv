...
\descript{Multi-level Simulation | {\bf In-progress}}
{\normalsize
\begin{tightemize}
...
\vspace{8pt}
\begin{tightemize}
% \item Whangbo, Joonho, Edwin Lim, Chengyi Lux Zhang, Kevin Anderson, Abraham Gonzalez,\custombold{ Raghav Gupta,} Nivedha Krishnakumar, et al. \custombold{"FireAxe: Multi-FPGA Simulation for Scale-Up Hardware Designs."} (Under submission)
